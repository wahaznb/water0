...
- **Reachable bottom** — every list scrolls clear of the floating dock, down to the GitHub link

## Install

One universal APK for every phone (arm64, old ARM, Chromebooks — zero native code, nothing to choose). Details in `../README.md`.

- File: `water0-v0.2-universal.apk`
